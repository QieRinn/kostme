...
export default function DashboardPartner() {
  return (
    <div className="dashboardpartner">
      <button
...
<<<<<<< HEAD
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Kos</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Laundry</span>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Kantin</span>
              </a>
            </li>
          </ul>
=======
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-cyan-700 dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Kos</span>
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Kantin</span>
                        </a>
                    </li>
